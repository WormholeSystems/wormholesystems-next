<script lang="ts">
	...
	import ConnectionMenu from './context-menu/ConnectionMenu.svelte';
	import MapMenu from './context-menu/MapMenu.svelte';
	import NodeMenu from './context-menu/NodeMenu.svelte';
